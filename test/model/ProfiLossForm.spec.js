...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgdlApi.ProfiLossForm();
  });
  ...
  describe('ProfiLossForm', function() {
    it('should create an instance of ProfiLossForm', function() {
      // uncomment below and update the code to test ProfiLossForm
      //var instance = new NgdlApi.ProfiLossForm();
      //expect(instance).to.be.a(NgdlApi.ProfiLossForm);
    });
