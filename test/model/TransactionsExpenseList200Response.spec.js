...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgdlApi.TransactionsExpenseList200Response();
  });
  ...
  describe('TransactionsExpenseList200Response', function() {
    it('should create an instance of TransactionsExpenseList200Response', function() {
      // uncomment below and update the code to test TransactionsExpenseList200Response
      //var instance = new NgdlApi.TransactionsExpenseList200Response();
      //expect(instance).to.be.a(NgdlApi.TransactionsExpenseList200Response);
    });
