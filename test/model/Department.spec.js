...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgdlApi.Department();
  });
  ...
  describe('Department', function() {
    it('should create an instance of Department', function() {
      ...
      //var instance = new NgdlApi.Department();
      //expect(instance).to.be.a(NgdlApi.Department);
    });
    ...
    it('should have the property headedBy (base name: "headed_by")', function() {
      // uncomment below and update the code to test the property headedBy
      //var instance = new NgdlApi.Department();
      //expect(instance).to.be();
    });
