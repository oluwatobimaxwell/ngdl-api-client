...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgdlApi.BudgetCycle();
  });
  ...
  describe('BudgetCycle', function() {
    it('should create an instance of BudgetCycle', function() {
      // uncomment below and update the code to test BudgetCycle
      //var instance = new NgdlApi.BudgetCycle();
      //expect(instance).to.be.a(NgdlApi.BudgetCycle);
    });
