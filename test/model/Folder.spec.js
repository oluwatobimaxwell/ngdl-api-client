...
(function(root, factory) {
  ...
  describe('Folder', function() {
    it('should create an instance of Folder', function() {
      ...
      //var instance = new NgdlApi.Folder();
      //expect(instance).to.be.a(NgdlApi.Folder);
    });
    ...
    it('should have the property isModuleFolder (base name: "is_module_folder")', function() {
      // uncomment below and update the code to test the property isModuleFolder
      //var instance = new NgdlApi.Folder();
      //expect(instance).to.be();
    });
