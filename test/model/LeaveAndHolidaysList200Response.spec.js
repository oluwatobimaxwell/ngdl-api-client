...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgdlApi.LeaveAndHolidaysList200Response();
  });
  ...
  describe('LeaveAndHolidaysList200Response', function() {
    it('should create an instance of LeaveAndHolidaysList200Response', function() {
      // uncomment below and update the code to test LeaveAndHolidaysList200Response
      //var instance = new NgdlApi.LeaveAndHolidaysList200Response();
      //expect(instance).to.be.a(NgdlApi.LeaveAndHolidaysList200Response);
    });
